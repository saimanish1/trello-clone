...
export const getAllCards = (columnIds) => {
    ...
    return dispatch => {
        ...
        axios.post('/cards/getallcards', {columnIds})
            .then(res => {
...
export const editColumnTitle = (editedTitle, columnId) => {
    ...
    return dispatch => {
        axios.post(`/columns/${columnId}?title=true`, {title: editedTitle})
            .then((res) => {
                dispatch({type: EDIT_COLUMN_TITLE, payload: {editedTitle, columnId}})
            })
